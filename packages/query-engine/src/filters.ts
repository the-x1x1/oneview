...
export function matchesFilter(field: FieldValue, filter: WorldFilter): boolean {
  ...
  switch (filter.op) {
    ...
    case 'eq':
      return field !== undefined && equals(field, v);
    case 'neq':
      return !(field !== undefined && equals(field, v));
    case 'gt':
      return ordered(field, v) > 0;
    case 'gte':
      return ordered(field, v) >= 0;
    case 'lt':
      return ordered(field, v) < 0;
    ...
    case 'contains': {
      ...
      if (typeof field === 'string')
        return typeof v === 'string'
          ? field.toLowerCase().includes(v.toLowerCase())
          : v !== undefined && field.toLowerCase().includes(String(v).toLowerCase());
...
export function matchesAll(
  resolve: (path: string) => FieldValue,
  filters: readonly WorldFilter[] | undefined,
): boolean {
