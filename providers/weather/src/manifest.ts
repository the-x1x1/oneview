...
export const NWS_MANIFEST: ProviderManifest = {
  ...
  settings: [
    {
      key: 'contact', label: 'Contact for the User-Agent', kind: 'string', placeholder: 'you@example.org or a URL',
      defaultLabel: 'Not configured — the User-Agent says so',
      description: 'api.weather.gov asks clients to identify themselves and may answer 403 without this. It is sent to weather.gov only.',
      helpUrl: 'https://www.weather.gov/documentation/services-web-api',
    },
    {
      key: 'areas', label: 'States and marine areas', kind: 'multi-enum', defaultLabel: 'The whole country',
      ...
      options: [
        ...
        { value: 'WI', label: 'Wisconsin' }, { value: 'WY', label: 'Wyoming' }, { value: 'DC', label: 'District of Columbia' }, { value: 'PR', label: 'Puerto Rico' },
      ],
    },
  ],
};
